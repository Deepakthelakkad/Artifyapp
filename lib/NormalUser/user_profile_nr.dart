...
class UserProfileNr extends StatefulWidget {
  const UserProfileNr({super.key});

  @override
  State<UserProfileNr> createState() => _UserProfileNrState();
}

class _UserProfileNrState extends State<UserProfileNr> {
  @override
