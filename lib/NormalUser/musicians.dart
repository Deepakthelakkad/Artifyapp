    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        ...
        builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          filteredArtists = artist.where((doc) {
            final name = doc['Name'].toString().toLowerCase();
            return name.contains(searchQuery);
          }).toList();

          final paginatedArtists = filteredArtists.skip(currentPage * itemsPerPage).take(itemsPerPage).toList();
                          ...
                          trailing: InkWell(
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      ArtistViewNr(id: paginatedArtists[index].id),
                                ),
                              );
                            },
                            child: Container(
