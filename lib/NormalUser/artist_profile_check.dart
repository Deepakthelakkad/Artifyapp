import 'package:artify_app/NormalUser/achievements_nr.dart';
...
class ArtistProfileCheck extends StatefulWidget {
  const ArtistProfileCheck({super.key});

  @override
  State<ArtistProfileCheck> createState() => _ArtistProfileCheckState();
}

class _ArtistProfileCheckState extends State<ArtistProfileCheck> {
  @override
